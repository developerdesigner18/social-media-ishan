  ...
  return (
    <div className='stroy-container'>
        <div>
            ...
            <div onClick={handleAddstory}><Avatar src={`http://localhost:5000/static/${localStorage.getItem('profileImage')}`} sx={{height:'60px',width:'60px',border:'3px solid #2E7D32'}} /></div>
            </Badge>
        </div>
